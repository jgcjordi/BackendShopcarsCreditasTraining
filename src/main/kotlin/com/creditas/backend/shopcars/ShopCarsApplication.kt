...
class OnBoot(
    ...
    override fun run(args: ApplicationArguments?) {
        ...
        val carLeon = carService.saveCar(Car(number_plate = "4458 ADS", model = leon, km = 54000,fuel_type = 2, price = 30000F, color = 9, year = 2010,  url_image = "https://www.coches.com/fotos_historicas/seat/Leon-Cupra-2006/seat_leon-cupra-2006_r15.jpg"))
        ...
        val carClaseA = carService.saveCar(Car(number_plate = "4458 ADS", model = claseA, km = 65000,fuel_type = 2, price = 25000F, color = 9, year = 2010,  url_image = "https://www.coches.com/fotos_historicas/amg/Mercedes-A45-4MATIC-W176-2015/amg_mercedes-a45-4matic-w176-2015_r8.jpg"))
