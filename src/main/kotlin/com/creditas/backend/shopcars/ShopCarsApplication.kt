...
class OnBoot(
    ...
    override fun run(args: ApplicationArguments?) {
        ...
        val carS11 = carService.saveCar(Car(number_plate = "6555 WER", model = s1, km = 24600, price = 14000F,fuel_type = 0, color = 2, url_image ="https://img.motor16.com/modelos/bmw-serie-1.jpg"))
