...
class OnBoot(
    ...
    override fun run(args: ApplicationArguments?) {
        ...
        val focus_Sportbreak = modelService.saveModel(Model(name = "Focus Sportbreak", brand = ford))
        ...
        val carFiesta2 = carService.saveCar(Car(number_plate = "4732 GHJ", model = fiesta, km = 200000,fuel_type = 4, price = 4000F, color = 6, url_image = "https://www.coches.com/fotos_historicas/ford/Fiesta/6457c76c211873fb8d44b2345dae758f.jpg"))
        ...
        val carFocus3 = carService.saveCar(Car(number_plate = "5665 FSW", model = focus, km = 52258, price = 21000F,fuel_type = 3, color = 4, url_image = "https://imagenes-cdn.autofacil.es/multimedia/fotos/2018/04/12/122594/widget_g.jpg    "))
        val carFocus4 = carService.saveCar(Car(number_plate = "9652 FSS", model = focus_Sportbreak, km = 87925, price = 29000F,fuel_type = 4, color = 9, url_image = "https://www.coches.com/fotos_historicas/ford/Focus-Vignale-Turnier-2018/ford_focus-vignale-turnier-2018_r40.jpg"))
        ...
        val carX1 = carService.saveCar(Car(number_plate = "5378 DTG", model = x1, km = 1200, price = 24000F,fuel_type = 1, color = 1, url_image ="https://www.coches.com/fotos_historicas/bmw/X1/8df0e4c7f73e6662d4a0e7a9b99dc434.jpg"))
        ...
        val carS11 = carService.saveCar(Car(number_plate = "6555 WER", model = s1, km = 24600, price = 14000F,fuel_type = 9, color = 2, url_image ="https://www.coches.com/fotos_historicas/bmw/1-Series-120d-Sport-Line-3-door-F21-2017/bmw_120d-sport-line-3-door-f21-2017_r33.jpg"))

        val carM3 = carService.saveCar(Car(number_plate = "7524 ABS", model = m3, km = 15000, price = 44000F,fuel_type = 1, color = 3, url_image ="https://hackercar.com/wp-content/uploads/2020/02/bmw-M340d-1.jpg"))
        ...
        val carJuke1 = carService.saveCar(Car(number_plate = "2855 LKR", model = juke, km = 0, price = 98500F,fuel_type = 2, color = 4, url_image ="https://www.coches.com/fotos_historicas/nissan/Juke/nissan_juke-2014_r4.jpg"))
