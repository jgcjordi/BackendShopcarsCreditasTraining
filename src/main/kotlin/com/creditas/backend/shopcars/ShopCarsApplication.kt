...
class OnBoot(
    ...
    override fun run(args: ApplicationArguments?) {
        ...
        val carMustang2 = carService.saveCar(Car(number_plate = "4362 LYR", model = mustang, km = 12500,fuel_type = 0, price = 325000F, color = 3, url_image = "https://cdn.topgear.es/sites/navi.axelspringer.es/public/styles/1200/public/media/image/2017/05/prueba-ford-mustang-gt_19.jpg?itok=037w0axH"))
        ...
        val carS1 = carService.saveCar(Car(number_plate = "4528 BWG", model = s1, km = 24600, price = 14000F,fuel_type = 0, color = 2, url_image ="https://img.motor16.com/modelos/bmw-serie-1.jpg"))
        ...
        val carJuke = carService.saveCar(Car(number_plate = "2565 LKR", model = juke, km = 0, price = 25000F,fuel_type = 0, color = 0, url_image ="https://imagenes-cdn.autofacil.es/multimedia/fotos/2019/10/09/170354/preview2col_mg.jpg?t=1570621209000"))
